...
class CodeWrapper(object):
    ...
    def _sanity_checks(self, middle_timings, lead_out, code):
    ...
    def _build_normalized_code(self, lead_out, cleaned_code, code):
    ...
    def __init__(
        ...
        if not self._sanity_checks(middle_timings, lead_out, code):
            raise DecodeError(
        ...
        self._code = self._build_normalized_code(lead_out, cleaned_code, code)
        self._original_code = self._original_code[:len(self._code)]
