...
class MainFrame:
    ...
    class Menu:
        ...
        New = u'&Nuevo'
        NewAction = u'A\xf1adir Accion'
        NewEvent = u'A\xf1adir Evento'
        NewFolder = u'A\xf1adir directorio'
        NewMacro = u'A\xf1adir Macro'
        Open = u'&Abrir'
        Options = u'&Opciones...'
        Paste = u'&Pegar'
        Redo = u'&Rehacer'
...
class AddActionDialog:
    ...
    title = u'Seleccione una accion para a\xf1adir...'
class AddPluginDialog:
    ...
    title = u'Escoja un plugin para a\xf1adir...'
    version = u'Version:'
class AddActionGroupDialog:
    caption = u'A\xf1adir Acciones?'
    message = u'EventGhost puede a\xf1adir un directorio con todas las acciones para este plugin a su estructura de configuracion. Si es lo que ud. desea hacer, seleccione la ubicacion donde desea a\xf1adirlos y presione aceptar.\n\nEn caso contrario presione el boton de Cancelar.'
class OptionsDialog:
...
class Plugin:
    class EventGhost:
        ...
        class AutoRepeat:
            ...
            description = u'Convierte la macro donde se a\xf1ada este comando en macro que se repite automaticamente.'
            seconds = u'segundos'
        ...
        class EnableExclusive:
            ...
            description = u'Esto habilitara una carpeta o una macro especificada en su configuraci\xf3n, pero tambi\xe9n inhabilita el resto de carpetas y las macros que sean parejos en el mismo nivel secundario de la estructura.'
    ...
    class Window:
        ...
        class Resize:
            ...
            description = u'Redimensiona una ventana a un tama\xf1o dado. '
    ...
    class Mouse:
        ...
        class GoDirection:
            ...
            label = u'Iniciar movimiento del raton direccion %.2f\xb0'
        ...
        class ToggleLeftButton:
            name = u'Bot\xf3n izquierdo de palanca'
            description = u'Bot\xf3n izquierdo de palanca del rat\xf3n'
