class General:
    ...
    deleteManyQuestion = u'Tento element m\xe1 %s subelement(y,\u016f).\nJsi si jist\xfd, \u017ee chce\u0161 smazat v\u0161echny ?'
    deletePlugin = u'Tento plugin je pou\u017eit akc\xed ve tv\xe9 konfiguraci.\nNem\u016f\u017ee\u0161 ho odstranit, dokud neodstran\xed\u0161 v\u0161echny akce, kter\xe9 ho pou\u017e\xedvaj\xed.'
    help = u'&Pomoc'
    moreHelp = u'V\xedce...'
...
class MainFrame:
    ...
    class Logger:
        ...
        timeHeader = u'\u010cas'
        welcomeText = u'-->V\xedt\xe1m t\u011b v aplikaci EventGhost<--'
    class Menu:
        About = u'&O aplikaci EventGhost...'
        AddPlugin = u'Vlo\u017eit Plugin...'
        Apply = u'Pou\u017e\xedt'
        CheckUpdate = u'Vyhledat nov\u011bj\u0161\xed verze...'
        ...
        Cut = u'&Vyjmout'
        Delete = u'O&dstranit'
        Disabled = u'Zak\xe1zat element'
        Edit = u'Editovat element...'
        EditMenu = u'&Editovat'
        Execute = u'&Spustit element'
        Exit = u'&Konec'
        ExpandAll = u'&Rozbalit v\u0161e'
        ExpandOnEvents = u'Automaticky &zv\xfdraznit element'
        ExpandTillMacro = u'Autom. rozbalit pouze do \xfarovn\u011b &makra'
        Export = u'Export...'
        FileMenu = u'&Soubor'
        Find = u'&Naj\xedt...'
        ...
        Rename = u'P\u0159ejmenovat element'
        Save = u'&Ulo\u017eit'
        SaveAs = u'Ulo\u017eit &jako...'
        SelectAll = u'&Vybrat v\u0161e'
        Undo = u'&Zp\u011bt (Undo)'
        ViewMenu = u'&Zobrazit'
        WebForum = u'Web f\xf3rum'
        WebHomepage = u'Domovsk\xe1 str\xe1nka EventGhost'
        WebWiki = u'Wikipedie'
    class SaveChanges:
...
class CheckUpdate:
    ...
    newVersionMesg = u'Byla vyd\xe1na nov\u011bj\u0161\xed verze aplikace EventGhost.\n\n\tTvoje verze:\t%s\n\tPosledn\xed verze:\t%s\n\nChce\u0161 nav\u0161t\xedvit str\xe1nku stahov\xe1n\xed hned?'
    title = u'Nov\xe1 verze aplikace EventGhost je k dispozici...'
    waitMesg = u'Pros\xedm \u010dekej, dokud EventGhost nez\xedsk\xe1 informace o nov\xfdch verz\xedch.'
...
class AddPluginDialog:
    ...
    noMultiload = u'Tento plugin nepodporuje v\xedce sou\u010dasn\xfdch instanc\xed a ty u\u017e m\xe1\u0161 jednu instanci tohoto pluginu ve sv\xe9 kofiguraci.'
    ...
    version = u'Verze:'
class OptionsDialog:
    CheckUpdate = u'Vyhled\xe1vat nov\u011bj\u0161\xed verze p\u0159i spu\u0161t\u011bn\xed'
    HideOnClose = u'Skr\xfdt hlavn\xed panel p\u0159i stisknut\xed zav\xedrac\xedho tla\u010d\xedtka'
...
class Plugin:
    class EventGhost:
        name = u'EventGhost'
        description = u'Tady jsou akce, kter\xe9 slou\u017e\xed p\u0159ev\xe1\u017en\u011b k \u0159\xedzen\xed funkce j\xe1dra aplikace EventGhost.'
        class AutoRepeat:
        ...
        class Jump:
            ...
            mesg2 = u'Pros\xedm vyber makro, kter\xe9 m\xe1 b\xfdt spu\u0161t\u011bno:'
            text2 = u'Sko\u010dit na:'
        ...
        class JumpIf:
            ...
            label1 = u'If %s goto %s'
            label2 = u'If %s gosub %s'
            mesg1 = u'V\xfdb\u011br makra...'
            mesg2 = u'Pros\xedm vyber makro, kter\xe9 m\xe1 b\xfdt spu\u0161t\u011bno, je-li podm\xednka spln\u011bna.'
            text1 = u'Jestli\u017ee:'
            text2 = u'Sko\u010dit na:'
            text3 = u'Vr\xe1tit se po proveden\xed'
        class JumpIfLongPress:
            ...
            label = u'Je-li tla\u010d\xedtko stisknut\xe9 %s sec, go to: %s'
            text1 = u'Je-li tla\u010d\xedtko stsknut\xe9 d\xe9le ne\u017e'
            text2 = u'sekund,'
            text3 = u'sko\u010dit na:'
            text4 = u'Vyber makro, na kter\xe9 se m\xe1 sko\u010dit...'
            text5 = u'Pros\xedm vyber makro, kter\xe9 by m\u011blo b\xfdt spu\u0161t\u011bno,\npokud je dosa\u017eeno nastaven\xe9 d\xe9lky stisknut\xed tla\u010d\xedtka.'
        class NewJumpIf:
            name = u'Sko\u010dit'
            ...
            mesg1 = u'V\xfdb\u011br makra...'
            mesg2 = u'Pros\xedm vyber makro, kter\xe9 by m\u011blo b\xfdt vykon\xe1no,\npokud v\xfdsledek ur\u010dit\xe9 akce odpov\xedd\xe1 podm\xednce.'
            text1 = u'Jestli\u017ee:'
            text2 = u'Sko\u010dit na:'
        ...
        class StopIf:
            name = u'Zastavit pokud'
            description = u'Zastav\xed prov\xe1d\u011bn\xed makra, pokud  je spln\u011bna zadan\xe1 podm\xednka (vyhodnocen\xed v\xfdrazu pythonem vrac\xed pravdu) .'
            label = u'Zastavit pokud %s'
        ...
        class TriggerEvent:
            name = u'Vygenerovat ud\xe1lost'
            description = u'Vygeneruje po\u017eadovanou ud\xe1lost (voliteln\u011b po ur\u010dit\xe9m \u010dase).'
    ...
    class System:
        ...
        class Execute:
            ...
            FilePath = u'Cesta k souboru, kter\xfd m\xe1 b\xfdt spu\u0161t\u011bn:'
        ...
        class SoundGroup:
            ...
            description = u'Tyto akce ovl\xe1daj\xed zvukovou kartu tv\xe9ho po\u010d\xedta\u010de.'
        class Standby:
    ...
    class Window:
        ...
        class FindWindow:
            ...
            drag1 = u'P\u0159et\xe1hni m\u011b\ndo okna.'
            drag2 = u'Te\u010f m\u011b p\u0159esu\u0148\ndo okna.'
        ...
        class SendKeys:
            ...
            description = u'Tato akce emuluje stisk kl\xe1ves pro ovl\xe1d\xe1n\xed ostatn\xedch program\u016f. Znaky, kter\xe9 jsou k ovl\xe1d\xe1n\xed pot\u0159eba, napi\u0161 do edita\u010dn\xedho pole. Pro emulov\xe1n\xed speci\xe1ln\xedch kl\xe1ves je t\u0159eba pou\u017e\xedt kl\xed\u010dov\xe1 slova a uzav\u0159\xedt je do slo\u017een\xfdch z\xe1vorek.\n\n<p>Nap\u0159\xedklad chce\u0161-li pou\u017e\xedt kl\xe1vesu "\u0161ipka nahoru", napi\u0161 <b>{Up}</b>. Pro zkombinov\xe1n\xed v\xedce kl\xe1ves m\u016f\u017ee\u0161 kombinovat v\xedce kl\xed\u010dov\xfdch slov (znak\u016f) pomoc\xed znam\xe9nka plus jako: <b>{Shift+Ctrl+F1}</b> nebo <b>{Ctrl+V}</b>. P\u0159i z\xe1pisu kl\xed\u010dov\xfdch slov nez\xe1le\u017e\xed na velikosti pou\u017eit\xfdch znak\u016f, tak\u017ee m\u016f\u017ee\u0161 napsat tak\xe9 {SHIFT+ctrl+F1}, pokud se ti to l\xedb\xed. <p>Pokud je u n\u011bkter\xfdch kl\xe1ves t\u0159eba rozli\u0161ovat mezi kl\xe1vesou na lev\xe9 a prav\xe9 stran\u011b kl\xe1vesnice (jako t\u0159eba u kl\xe1vesy s logem Windows), mohou b\xfdt kl\xed\u010dov\xe1 slova ozna\u010dena p\u0159edponou "L" nebo "R":<br><b>{Win}</b> nebo <b>{LWin}</b> nebo <b>{RWin}</b><p>A tady je seznam zbytku kl\xed\u010dov\xfdch slov, ker\xfdm EventGhost rozum\xed:<br><b>{Ctrl}</b> nebo <b>{Control}<br>{Shift}<br>{Alt}<br>{Return}</b> nebo <b>{Enter}<br>{Back}</b> nebo <b>{Backspace}<br>{Tab}</b> nebo <b>{Tabulator}<br>{Esc}</b> nebo <b>{Escape}<br>{Spc}</b> nebo <b>{Space}<br>{Up}<br>{Down}<br>{Left}<br>{Right}<br>{PgUp}</b> nebo <b>{PageUp}<br>{PgDown}</b> nebo <b>{PageDown}<br>{Home}<br>{End}<br>{Ins}</b> nebo <b>{Insert}<br>{Del}</b> nebo <b>{Delete}<br>{Pause}<br>{Capslock}<br>{Numlock}<br>{Scrolllock}<br>{F1}, {F2}, ... , {F24}<br>{Apps}</b> (To je kl\xe1vesa kontextov\xe9 nab\xeddky)<b><br><br></b>Toto bude emulovat kl\xe1vesy numerick\xe9 kl\xe1vesnice:<b><br>{Divide}<br>{Multiply}<br>{Subtract}<br>{Add}<br>{Decimal}<br>{Numpad0}, {Numpad1}, ... , {Numpad9}</b>'
        class SendMessage:
    ...
    class DirectoryWatcher:
        ...
        description = u'\nGeneruje ud\xe1losti, jestli\u017ee soubory v ur\u010den\xe9 slo\u017ece jsou vytvo\u0159eny, smaz\xe1ny\nnebo zm\u011bn\u011bny.'
    ...
    class NetworkSender:
        ...
        description = u'\nProst\u0159ednictv\xedm TCP/IP vys\xedl\xe1 ud\xe1losti k pluginu "S\xed\u0165ov\xfd p\u0159ij\xedma\u010d ud\xe1lost\xed".'
        host = u'Hostitel:'
        password = u'Heslo:'
        port = u'Port:'
        class Map:
    ...
    class Task:
        name = u'Ud\xe1lost, generovan\xe1 vytvo\u0159en\xedm nebo "p\u0159epnut\xedm" \xfalohy'
        description = u'Generuje ud\xe1losti, jestli\u017ee \xfaloha je vytvo\u0159ena nebo "p\u0159epnuta".'
    class TestPatterns:
        class Close:
            name = u'Zav\u0159\xedt'
