...
author = "jinxdone"
description = """
This plugin reads Lirc eventstrings over a TCP-connection and generates 
EventGhost events accordingly.

<p>The configurable options are:
<UL>
...
Generate enduring events for EventGhost, this involves a workaround that will 
add 400ms of "lag" into your keypresses. <u>Overrides any other settings 
except the optional remote name.</u>
</UL>
"""