...
class ToastNotifier(object):
    ...
    def _show_toast(
        ...
        nid = (
            ...
            0,                      # UINT  uID;
            flags,                  # UINT  uFlags;
            WM_USER + 52,           # UINT  uCallbackMessage;
            hicon,                  # HICON hIcon;
            "Tooltip for trayicon",  # CHAR  szTip
            msg,  # DWORD dwState;
            200,  # DWORD dwStateMask;
            title,  # CHAR  szInfoTitle[64];
            0,  # DWORD dwInfoFlags;
            #GUID("{7EB106DC-468D-4345-9CFE-B0021039114B}")  # GUID  guidItem;
        )
        # {7C5A40EF-A0FB-4BFC-874A-C0F2E0B9FA8E}\EventGhost\EventGhost.exe
        # HKEY_CLASSES_ROOT\AppID\{7EB106DC-468D-4345-9CFE-B0021039114B} EventGhost
        ...
        Shell_NotifyIcon(
            ...
            (
                self.hwnd,              # HWND  hWnd;
                0,                      # UINT  uID;
                NIF_INFO,               # UINT  uFlags;
                WM_USER + 52,           # UINT  uCallbackMessage;
                hicon,                  # HICON hIcon;
                "Balloon Tooltip",      # CHAR  szTip
                msg,                    # DWORD dwState;
                200,                    # DWORD dwStateMask;
                title,                  # CHAR  szInfoTitle[64];
                0,                      # DWORD dwInfoFlags;
