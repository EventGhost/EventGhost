...
class CodeWrapper(object):
    ...
    def __init__(self, encoding, lead_in, lead_out, middle_timings, bursts, tolerance, code):
        ...
        if self._stream_encoding == 'manchester':
            mark, space = bursts[0]
                ...
                for timing in middle_timings:
                    ...
                    for timing in middle_timings[:]:
                        ...
                        if isinstance(timing, tuple):
                            ...
                            cleaned_code += [timing]
                            break
                        elif self._match(burst, timing + mark):
                            pairs += [mark]
                            cleaned_code += [mark, timing]
                            middle_timings.remove(timing)

                            break
                        elif self._match(burst, timing + space):
                            pairs += [space]
            ...
            def _check_middles():
                ...
                def _check_timing():
                    ...
                    if (
                        ...
                        # print 'MATCH MIDDLE 7:', m, space, burst
                    ...
                    if (
                        ...
                        # print 'MATCH MIDDLE 8:', s, mark, burst
                        pairs.append([mark])
